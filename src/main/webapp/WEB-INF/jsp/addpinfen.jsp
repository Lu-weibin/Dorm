...
<html>
	...
	<body class="sidebar-fixed header-fixed">
									...
									<form id="pinfenForm">
										...
										<div class="col-lg-4" style="text-align-last: center">
											<div class="form-group">
												<label for="customerName">分数：</label>
											...
											<button type="button" class="btn btn-primary text-right" style="" onclick="addpinfen()">评分</button>
										</div>
									</form>
								</div>
							</div>
		...
		<script type="text/javascript">
			function addpinfen(){
				$.post("addpinfen",$('#pinfenForm').serialize(),function(data){
					if(data=="ok"){
						alert("录入成功！");
						return;
					}
