	...
	<body class="sidebar-fixed header-fixed">
									...
									<form id="studentForm" class="form-inline">
										<div class="" style="text-align-last: center;">
											...
											<div class="form-group">
												...
												<div class="col-lg-6">
													<input type="text" class="form-control" id="banji" name="banji">
												</div>					
											</div>
											<div class="form-group">
												<div class="col-lg-4">
											...
											<div class="form-group">
												...
												<div class="col-lg-6">
													<input type="radio" class="form-control" id="sex" name="sex" value="男">男</input>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input type="radio" class="form-control" id="sex" name="sex" value="女">女</input>
												</div>					
											</div>
											
											<div class="form-group">
												<div class="col-lg-4">
													<label for="customerName">楼号：</label>
												</div>
												<div class="col-lg-6">
											...
											<div class="form-group">
												...
												<div class="col-lg-6">
													<input type="text" class="form-control" id="dormNum" name="dormNum">
												</div>					
											</div>
											<div class="form-group">
												<div class="col-lg-4">
													<label for="customerName">床号：</label>
												</div>
												<div class="col-lg-6">
													<select name="chuanhao" class="form-control">
											...
											<button type="button" class="btn btn-primary text-right" style="margin-left:48px" onclick="addstudent()">添加</button>
										</div>
		...
		<script type="text/javascript">
			function addstudent(){
				...
				$.post("addstudent",$('#studentForm').serialize(),function(data){
					alert(data);
				});
			}
		</script>
