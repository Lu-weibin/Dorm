...
<html>
	...
	<body class="sidebar-fixed header-fixed">
								...
								<div class="text-center" style="">
									<form id="suguanForm">
										<div class="col-lg-4" style="text-align-last: center">
											...
											<div class="form-group">
												<label for="customerName">密码：</label>
												<input type="text" class="form-control" id="password" name="password" placeholder="不填则默认为 0000">
											</div>
											<div class="form-group">
											...
											<button type="button" class="btn btn-primary text-right" style="" onclick="addsuguan()">添加</button>
										</div>
									</form>
								</div>
							</div>
		...
		<script type="text/javascript">
			function addsuguan(){
				$.post("addsuguan",$('#suguanForm').serialize(),function(data){
					alert(data);
				});
