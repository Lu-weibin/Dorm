...
<html>
	...
	<body class="sidebar-fixed header-fixed">
								...
								<div class="text-center" style="">
									<form id="sushenoticeFomr">
										<div class="col-lg-4">
											...
											<button type="button" class="btn btn-primary text-right" style="" onclick="addsushenotice()">发布</button>
										</div>
									</form>
								</div>
							</div>
		...
		<script type="text/javascript">
			function addsushenotice(){
				$.post("addsushenotice",$('#sushenoticeFomr').serialize(),function(data){
					if(data=="ok"){
						alert("录入成功！");
						return;
					}
