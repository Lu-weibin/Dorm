									...
									<form id="baoxiuForm">
										<div class="col-lg-4">
											<div class="form-group">
												<label for="customerName">请填写报修信息：</label>
												<textarea name="description" id="description" class="form-control" rows="5" cols="5" ></textarea>
											</div>
											<button type="button" class="btn btn-primary text-right" style="" onclick="addbaoxiu()">确定</button>
										</div>
									</form>
								</div>
							</div>
...
<script type="text/javascript">
	function addbaoxiu(){
		...
		$.post("addbaoxiu",{"description":description},function(data){
			alert(data);
		});
	}
</script>
